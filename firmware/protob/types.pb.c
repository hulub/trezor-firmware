...
const pb_field_t ElGamalTupleType_fields[3] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, STATIC  , FIRST, ElGamalTupleType, R, R, 0),
    PB_FIELD2(  2, BYTES   , REQUIRED, STATIC  , OTHER, ElGamalTupleType, C, R, 0),
    PB_LAST_FIELD
};
