...
const pb_field_t TestIn_fields[3] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, STATIC  , FIRST, TestIn, message, message, 0),
    PB_FIELD2(  2, UINT32  , REQUIRED, STATIC  , OTHER, TestIn, number, message, 0),
    PB_LAST_FIELD
};

const pb_field_t TestOut_fields[2] = {
    PB_FIELD2(  1, STRING  , OPTIONAL, STATIC  , FIRST, TestOut, message, message, 0),
    PB_LAST_FIELD
};

const pb_field_t EosVote_fields[4] = {
    PB_FIELD2(  1, BYTES   , REPEATED, STATIC  , FIRST, EosVote, L, L, 0),
    PB_FIELD2(  2, STRING  , REPEATED, STATIC  , OTHER, EosVote, candidates, L, 0),
    PB_FIELD2(  3, BYTES   , REQUIRED, STATIC  , OTHER, EosVote, Y, candidates, 0),
    PB_LAST_FIELD
};
...
const pb_field_t EosGetPublicKey_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t EosPublicKey_fields[2] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, STATIC  , FIRST, EosPublicKey, PublicKey, PublicKey, 0),
    PB_LAST_FIELD
};
